...
import chatbot_driving_post from "./controllers/chatbot/chatbot_driving_post.js";
import chatbot_marksheet_post from "./controllers/chatbot/chatbot_marksheet_post.js";
import chatbot_pan_card_post from "./controllers/chatbot/chatbot_pan_card_post.js";
import chatbot_passport_post from "./controllers/chatbot/chatbot_passport_post.js";
...
app.post("/chatbot/driving_details", verify, pass_verify, user_id, p_user_id, encrypt, chatbot_driving_post);
app.post("/chatbot/marksheet_details", verify, pass_verify, user_id, p_user_id, encrypt, chatbot_marksheet_post);
app.post("/chatbot/pan_card_details", verify, pass_verify, user_id, p_user_id, encrypt, chatbot_pan_card_post);
app.post("/chatbot/passport_details", verify, pass_verify, user_id, p_user_id, encrypt, chatbot_passport_post);
